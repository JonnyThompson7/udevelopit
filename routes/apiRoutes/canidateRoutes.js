...
router.get('/canidates', (req, res) => {
  const sql = `SELECT canidates.*, parties.name 
             AS party_name 
             FROM canidates 
             LEFT JOIN parties 
             ON canidates.party_id = parties.id`;
...
router.get('/canidate/:id', (req, res) => {
  const sql = `SELECT canidates.*, parties.name 
             AS party_name 
             FROM canidates 
             LEFT JOIN parties 
...
// Delete a Candidate
router.delete('/canidate/:id', (req, res) => {
